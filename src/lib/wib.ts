 ...
 * Strings without timezone info are treated as WIB (UTC+7).
 */
export function parseDate(val: unknown): Date | null {
  ...
  if (typeof val === 'number') {
    // Could be a Google Sheets serial date (days since 1899-12-30)
    // or a Unix timestamp in ms
    if (val > 25569 && val < 100000) {
      // Google Sheets serial date → convert to JS Date
      // Sheets epoch: 1899-12-30, Unix epoch offset = 25569 days
  ...
  // ISO-like: 2026-04-09 14:18:37 or 2026-04-09T14:18:37+07:00 etc
